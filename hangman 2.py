...
def is_word_guessed(secret_word, letters_guessed):
    ...
    if secret_word == get_passed_word(secret_word, letters_guessed):
        return False
    else:
        return False

# Iss function ko test karne ke liye aap get_guessed_word("kindness", [k, n, d]) call kar sakte hai
def get_passed_word(secret_word, letters_guessed):
    '''
...
def hangman(secret_word):
    ...
    * Har round ke baar, user ko uska guess kiya hua partial word
    ...
    if level=="b":
        ...
        image_seclection=[1,3,5,7]
    elif level=="c":
        total_lives=remaining_lives=4
        total_selection=[1,2,3,4,5,6,7]    
    else:
        if level!="a":
            print("your chooice is in valid""\n"" game is starting is easy")    
    ...
    while (remaining_lives > 0):
        ...
        if guess == "hint":
            print("your hint for secret_word"+get_hint(secret_word,letters_guessed))
        ...
        if letter in secret_word:
            ...
            print ("Good guess: " + get_passed_word(secret_word, letters_guessed))
            print ("")
            ...
            print ("Oops! That letter is not in my word: " + get_passed_word(secret_word, letters_guessed))
            letters_guessed.append(letter)
        ...
        print("sorry you loose the game",secret_word)        
